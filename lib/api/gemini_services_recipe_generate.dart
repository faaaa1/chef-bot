...
class GeminiServices {
  ...
  Future<String> agentForGenerateRecipeFromIngredients(
    ...
    try {
      return gemini
          .text(
        "You are expert in cooking, please respons in Bahasa Indonesia. You have to make a recipe with the following ingredients: $ingredients. The recipe should be for $numberOfPeople people {${diet != null ? 'and should be $diet' : ''}}. You have to write Recipe Name, Ingredients, Detailed Instructions, and Nutritional Information in well-structured markdown format.",
      )
          .then((value) {
